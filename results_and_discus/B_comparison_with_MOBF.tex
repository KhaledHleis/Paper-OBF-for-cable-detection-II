...
\hline
\textbf{Basis} &
\shortstack{\textbf{Cable OBF}\\$(M=0)$} &
...
Building on the previous results, we evaluated the receiver operating characteristic (ROC) curve using both the analytical expression reported in the literature,
\[
P_d = \bar F_{\chi^2_v(\lambda)}\bigl(\bar F_{\chi^2_v}(P_{fa})\bigr),
\]
